...
export JOB_NAME=nanugpt-openwebtext-tokens10b
...
bash ${SCRIPT_DIR}/volcano_submit.sh train.py configs/train_gpt2/openwebtext_tokens10b.yaml --general.project_name ${JOB_NAME} $@