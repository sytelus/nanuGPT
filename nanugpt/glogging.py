...
std_metrics['default'] = [
                            ...
                            {"name": "train/tokens", "step_metric":"train/step", "summary":"last"},
                            {"name": "train/loss", "step_metric":"train/step", "summary":"last"},
                            {"name": "train/best_loss", "step_metric":"train/step", "summary":"last"},
                            {"name": "train/best_loss_step", "step_metric":"train/step", "summary":"last"},
                            {"name": "train/ppl", "step_metric":"train/step", "summary":"last"},
                            ...
                            {"name": "train/step_loss", "step_metric":"train/step", "summary":"last"},
                            {"name": "train/step_ppl", "step_metric":"train/step", "summary":"last"},

                            {"name": "val/best_loss", "step_metric":"train/step", "summary":"last"},
                            {"name": "val/generalization_gap", "step_metric":"train/step", "summary":"last"},

                            {"name": "val/best_loss_step", "step_metric":"train/step", "summary":"last"},
                            {"name": "val/loss", "step_metric":"train/step", "summary":"last"},
                            {"name": "val/loss", "step_metric":"train/step", "summary":"last"},
                            {"name": "val/ppl", "step_metric":"train/step", "summary":"last"},
                            ...
                            {"name": "val/time_s", "step_metric":"train/step", "summary":"last"},
                            {"name": "run/checkpoint_time_s", "step_metric":"train/step", "summary":"last"},

                            {"name": "test/loss", "step_metric":"train/step", "summary":"last"},
                            {"name": "test/ppl", "step_metric":"train/step", "summary":"last"},
                            ...
                            {"name": "run/w_norm", "step_metric":"train/step", "summary":"last"},
                            {"name": "run/flops", "step_metric":"train/step", "summary":"last"},
                            {"name": "tokens_per_sec", "step_metric":"train/step", "summary":"last"},
                    ]
std_metrics['classification'] = std_metrics['default'] +[
                        {"name": "train/acc", "step_metric":"train/step", "summary":"last"},
                        {"name": "train/step_acc", "step_metric":"train/step", "summary":"last"},
                        {"name": "test/acc", "step_metric":"train/step", "summary":"last"},
                        {"name": "val/acc", "step_metric":"train/step", "summary":"last"},
                    ]
